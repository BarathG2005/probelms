...
class Solution:
    def minMen(self, arr):
        ...
        #the maximum to find the most possible end , and there no increment the 0 to 1st cur and then that cur too the next most possible 
         #the max is dynamically find in the range of th between